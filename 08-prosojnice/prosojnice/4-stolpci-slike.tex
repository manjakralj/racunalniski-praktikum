...
\begin{columns}
    ...
    \column{0.45\textwidth}
	      \only{\includegraphics[width=50mm]{prosojnice/slike/fig-1.png}}<1>%
	      \only{\includegraphics[width=50mm]{prosojnice/slike/fig-2.png}}<2>%
		  \only{\includegraphics[width=50mm]{prosojnice/slike/fig-3.png}}<3>%
		  \only{\includegraphics[width=50mm]{prosojnice/slike/fig-4.png}}<4>%
		  \only{\includegraphics[width=50mm]{prosojnice/slike/fig-5.png}}<5>%
		  \only{\includegraphics[width=50mm]{prosojnice/slike/fig-6.png}}<6>%
		  \only{\includegraphics[width=50mm]{prosojnice/slike/fig-7.png}}<7>%
\end{columns}
\end{frame}
...
\begin{columns}
    ...
    \column{0.45\textwidth}
	      \begin{tikzpicture}
				...
				\coordinate [label={[below]:$C$}] (C) at (0,{-\t});
				\fill (C) circle (2pt);
				\pause
